                ...
                >
                  <div className="col-md-12">
                    <div className="about-desc">
                      ...
                      <p>
                        I am a undergrade student from Amrit Campus with
                        computer science as my major.I love exploring new
                        technologies and often amazed by the progress we as a
                        human species have made so far in the recent years
              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                  ...
                  <div className="desc">
                    ...
                    <p>
                      I have experience building websites ,mobile apps and
                      Desktop Apps using JavaScript,React,HTML and CSS.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="services color-3">
                  ...
                  <div className="desc">
                    ...
                    <p>
                      ...
                      fundamental concepts of DSA and DAA.
                    </p>
                  </div>
                </div>
              </div>
