        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              />
              <h1 id="colorlib-logo">
                <a href="index.html">Sandip Basnet</a>
              </h1>
              <span className="email">
                <i className="icon-mail" /> khaptadisandip@gmail.com
              </span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/sandipbasnet/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://github.com/developer-sandip"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://medium.com/@sandipbasnet"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
